...
public class HttpClientHelper {
	...
	public static String httpClientPost(String urlParam, Map<String, Object> params, String charset) {
		StringBuffer resultBuffer = null;
		//HttpClient client = new //new DefaultHttpClient();
	 ...
	 * @time:2016年5月17日 下午3:28:23
	 */
	public static HttpResponse httpClientPost2(String urlParam, Map<String, Object> params, String charset) {
		//StringBuffer resultBuffer = null;
	 ...
	 */
	public static HttpResponse httpClientGet2(String urlParam, Map<String, Object> params, String charset) {
		//StringBuffer resultBuffer = null;
		HttpResponse response = null;
